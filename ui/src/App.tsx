...
function Sprite() {
  ...
  return (
    <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
      ...
      <symbol id="i-mark" viewBox="0 0 32 32"><path d="M23.5 6.2A11.5 11.5 0 1 0 23.5 25.8 9 9 0 1 1 23.5 6.2Z" fill="currentColor" /><circle cx="24.5" cy="16" r="2.2" fill="currentColor" /></symbol>
    </svg>
  );
}
